...
export const callCreateDoctor = (
  ...
  return instance.post("/api/doctor/create-doctor", {
    email,
    password,
    firstName,
    lastName,
...
export const updateDoctor = (
  ...
  return instance.put("/api/doctor/update-doctor", {
    _id,
    email,
    firstName,
    lastName,
...
export const deleteDoctor = (_id) => {
  return instance.delete(`/api/doctor/delete-doctor/${_id}`);
};
...
export const createChuyenKhoa = (name, description, image) => {
  return instance.post("/api/doctor/create-chuyen-khoa", {
    name,
    description,
    image,
  });
...
export const deleteChuyenKhoa = (_id) => {
  return instance.delete(`/api/doctor/delete-chuyen-khoa/${_id}`);
};
export const updateChuyenKhoa = (_id, name, description, image) => {
  return instance.put("/api/doctor/update-chuyen-khoa", {
    _id,
    name,
    description,
    image,
...
export const createChucVu = (name, description) => {
  return instance.post("/api/doctor/create-chuc-vu", {
    name,
    description,
  });
};
export const deleteChucVu = (_id) => {
  return instance.delete(`/api/doctor/delete-chuc-vu/${_id}`);
};
export const updateChucVu = (_id, name, description) => {
  return instance.put("/api/doctor/update-chuc-vu", {
    _id,
    name,
    description,
  });
...
export const createPhongKham = (name, address, description, image, sdtPK) => {
  return instance.post("/api/doctor/create-phong-kham", {
    name,
    address,
    description,
    image,
...
export const deletePhongKham = (_id) => {
  return instance.delete(`/api/doctor/delete-phong-kham/${_id}`);
};
export const updatePhongKham = (
  ...
  return instance.put("/api/doctor/update-phong-kham", {
    _id,
    name,
    address,
    description,
...
export const createBenhNhan = (
  ...
  return instance.post("/api/users/create-benh-nhan", {
    email,
    password,
    firstName,
    lastName,
...
export const updateBenhNhan = (
  ...
  return instance.put("/api/users/update-benh-nhan", {
    _id,
    email,
    password,
    firstName,
...
export const addTimeKhamBenh = (date, time, _id) => {
  return instance.post("/api/doctor/add-time", {
    date,
    time,
    _id,
  });
...
export const xoaLichCu = (_id) => {
  return instance.post("/api/doctor/delete-old-time-slots", { _id: _id });
};
...
// dat lich kham
export const datLichKhamBenh = (data) => {
  return instance.post("/api/doctor/dat-lich-kham", data);
};
export const datLichKhamBenhVnPay = (data) => {
  return instance.post("/api/doctor/dat-lich-kham-vnpay", data);
};
...
export const aiSuggest = (query) => {
  const URL_BACKEND = `/api/chatgpt/ai-suggest?${query}`;
  return instance.get(URL_BACKEND);
};
